      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={`/${locale}/help`} className="text-muted-foreground hover:text-foreground">
                  {t("help")}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/shipping`} className="text-muted-foreground hover:text-foreground">
                  {t("shipping")}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/returns`} className="text-muted-foreground hover:text-foreground">
                  {t("returns")}
                </Link>
              </li>
              <li>
